...
- [X] T064 [US5] 小程序组织业绩页面于 `miniProgram/pages/org-performance/`（组织汇总 + 成员贡献值列表），入口按组织管理员身份显示，新增 API 服务于 `miniProgram/services/`——页/服务/入口门控（orgRole=admin）完成，demo 走 mock 数据
...
- [X] T066 [P] 更新 README/文档：README.md 组织结构描述、`docs/` 相关接口文档同步组织模型
