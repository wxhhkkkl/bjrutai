...
test('incomplete profile always returns to required profile setup', () => { assert.equal(getEntry({ userId:'p', role:'personal', profileCompleted:false, activationStatus:'active' }).url, '/pages/auth/profile-setup/index') })
