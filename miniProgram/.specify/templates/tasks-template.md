...
**Tests**: Include automated tests for shared behavior, masking, routing, and
interface contracts. Every story requires a runnable acceptance-validation task,
even when an automated UI test is not practical.
...
- [ ] T010 Define mock fixtures without real personal or credential data
- [ ] T011 Define loading, empty, error, and no-permission shared states
...
- [ ] T014 [US1] Validate the story in WeChat Developer Tools against confirmed UI and safe-area requirements
...
- [ ] TXXX Verify masking and confirm no production personal data appears in fixtures or logs
- [ ] TXXX Validate iOS and Android WeChat viewports, touch targets, text overflow, and Tab/navigation rules
